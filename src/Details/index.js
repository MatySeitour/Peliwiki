...
function Details({ }) {
        ...
        <div>
            {!detailsLoading ?
                ...
                <>
                    ...
                    <ul className="movie-loading__container">
                        {detailsImgLoading.map((movie) => (
                            <li key={movie.id} className="movies-loading"></li>
                        ))}
                    </ul>
                </>
            }
    ...
    // else {
    //     return [
    // <section key={idKeyDetails[0].id} className="movieDetail-container">
    //     <div key={idKeyDetails[1].id} style={sectionStyle} className="movie-image">
    //         <div key={idKeyDetails[2].id} className="background-opacity"></div>
    //         <div key={idKeyDetails[3].id}
    //             onClick={() => {
    //                 window.history.back()
    //                 window.scrollTo(0, 0)
    //             }}
    ...
    //     <article key={idKeyDetails[4].id} className="movieDescription">
    //         <div key={idKeyDetails[5].id} className="movieDescription-container">
    //             <div key={idKeyDetails[6].id} className="movieDescription-details">
    //                 <h5 className="movieDescription-title">{details.title}</h5>
    //                 <div key={idKeyDetails[7].id} className="movieDescription-rate"><span className="movieDetails-star">★</span><p>{details.popularity}</p></div>
    //             </div>
    //             <div key={idKeyDetails[8].id} className="movieDescription-overview__container">
    //                 <p className="movieDescription-overview">{details.description}</p>
    //             </div>
    //             <div key={idKeyDetails[9].id} className="movieDetail-genres">
    //                 {details.relatedGenres.map((genre) => (
    //                     <RelatedGenres
    //                         key={genre.id}
    //                         genreId={genre.id}
    ...
    //     <BelongColection
    //         key={idKeyDetails[10].id}
    //         belongMovies={belongsColection}
    //         movieId={detailsMovieId}
    //     />,

    //     <SimilarMovies
    //         key={idKeyDetails[11].id}
    //         similarIdMovie={detailsMovieId}
    //     />
